...
export default function WorkSchedule() {
    ...
    return ( <
        Box sx = {
            ...
            viewMode === 'weekly' ? ( <
                CalendarWeeklyView tasks = { tasks }
                farmers = { farmers }
                ...
                exclusive onChange = {
                    (e, newMode) => newMode && setViewMode(newMode) } >
                <
...

                {
                    viewMode === 'calendar' && ( <
                        ...
                        sx = {
                            { fontWeight: 'bold', minWidth: 200, textAlign: 'center' } } > { currentDate.toLocaleDateString('vi-VN', { month: 'long', year: 'numeric' }) } <
                        /Typography> <
                        IconButton onClick = {
                            () => navigateMonth(1) } >
                        <
                        ...
                        <
                        Box sx = {
                            { display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)', borderBottom: '1px solid #e0e0e0' } } > {
                                ...
                                return ( <
                                        ...
                                        () => day && handleDateClick(day) } >
                                    {
                                        day && ( <
                                            ...
                                            sx = {
                                                { fontWeight: isToday ? 'bold' : 'normal' } } > { day.getDate() } <
                                            /Typography> <
                                            Box sx = {
                                                { mt: 1 } } > {
                    ...
                    viewMode === 'list' && ( <
                        ...
                        TableBody > {
                            tasks.map((task) => ( <
                                ...
                                TableCell > { taskTypes.find(t => t.value === task.loai_cong_viec) ? .label } <
                                /TableCell> <
                                TableCell > {
                                    task.ma_nguoi_dung ? (
                                        (() => {
                                ...
                                TableCell >
                                <
                                Chip label = { statuses.find(s => s.value === task.trang_thai) ? .label }
                                color = { getStatusColor(task.trang_thai) }
                                size = "small" /
                                >
                                <
                                ...
                                TableCell >
                                <
                                Chip label = { priorities.find(p => p.value === task.uu_tien) ? .label }
                ...
                fullWidth >
                <
                DialogTitle > { editingTask ? 'Chỉnh sửa công việc' : 'Thêm công việc mới' } <
                /DialogTitle> <
                DialogContent >
                <
                ...
                <
                Button onClick = {
                    () => setOpenDialog(false) } > Hủy < /Button> <
                ...
                DialogContent > {
                    viewingTask && ( <
                        ...
                        Chip label = { viewingTask.trang_thai }
                        ...
                        Chip label = { viewingTask.uu_tien }
