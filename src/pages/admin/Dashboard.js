...
export default function Dashboard() {
    ...
    return ( <
        ...
        sx = {
            ...
            Box
            sx = {
                { width: 360, backgroundColor: "#040404", minHeight: "100%", color: "white" } }
            role = "presentation"
            ...
            style = {
                { fontSize: "20px", listStyle: "none", padding: 0, margin: 0 } } >
            <
            li >
            <
            LanguageIcon style = {
                { color: "white" } }
            /> <
            a href = "mailto:support@donghonuoc.vn"
            ...
            /> <
            span style = {
                { marginLeft: 8 } } > 614 Điện Biên Phủ,
            Quận 10,
            TP.HCM < /span> <
            /li> <
            /ul> <
