...
export default function Dashboard() {
    ...
    return ( <
        ...
        IconButton sx = {
            { bgcolor: "white", color: "black", ml: 2, "&:hover": { bgcolor: "#eee" } } }
        ...
        <
        Box sx = {
            { width: 'full', backgroundColor: '#040404', height: '180%', color: 'white' } }
        role = "presentation"
        ...
        /Box> <
        Box sx = {
            { backgroundColor: '#040404', height: '100%', color: 'white' } }
        role = "presentation"
        onClick = { toggleDrawer(false) } >
        <
        List >
        ...
        style = {
            { fontSize: '20px' } } >
        <
        li > < LanguageIcon style = {
            { color: 'white' } }
        />  <a href="mailto:support@donghonuoc.vn" className="text-blue-400 hover:underline">support@donghonuoc.vn</a > < /li> <
        li > < PhoneIcon style = {
            { color: 'white' } }
        />   <a href="tel:19001234" className="text-blue-400 hover:underline">1900 1234</a > < /li> <
        li > < LocationOnIcon style = {
            { color: 'white' } }
        /><a href="614 Điện Biên Phủ, Quận 10, TP.HCM" className="text-blue-400 hover:underline">614 Điện Biên Phủ, Quận 10, TP.HCM</a > < /li> <
        /ul> <
        /ListItem> <
        /List> <
        /Box> <
