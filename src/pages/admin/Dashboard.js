      ...
      >
        <Toolbar sx={{ minHeight: 56 }}>
          ...
          <div style={{ display: "inline-block", cursor: "pointer" }} onMouseLeave={handleClose}>
            ...
            <Menu id="fade-menu" anchorEl={anchorEl} open={open1} TransitionComponent={Fade} MenuListProps={{ onMouseLeave: handleClose }}>
          ...
          <IconButton sx={{ bgcolor: "white", color: "black", ml: 2, "&:hover": { bgcolor: "#eee" } }} onClick={toggleDrawer(true)}>
            <MenuIcon />
          </IconButton>
        </Toolbar>
      </AppBar>
