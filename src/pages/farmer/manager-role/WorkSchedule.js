...
const WorkScheduleFullWeek = () => {
    ...
    return ( <
        ...
        Select value = { filterTask }
        onChange = {
            (e) => setFilterTask(e.target.value) }
        style = {
            { minWidth: 150 } } >
        <
        MenuItem value = "Tất cả" > Tất cả < /MenuItem> {
        ...
        <
        Button onClick = {
            () => handleUpdateStatus("Hoàn thành") }
        color = "success" >
        Hoàn thành <
        /Button> <
        Button onClick = {
            () => handleUpdateStatus("Đang làm") }
        color = "warning" >
        Đang làm <
        /Button> <
        Button onClick = {
            () => handleUpdateStatus("Báo lỗi") }
        color = "error" >
        Báo lỗi <
        /Button> <
        /DialogActions> <
