                                ...
                                <Grid item xs={12} sm={4}>
                                    <Box sx={{ textAlign: 'center' }}>
                                        <Typography variant="h4" color="primary">
                                            {tasks.filter(t => getTaskTimeStatus(t).status === 'current').length}
                                        </Typography>
                                ...
                                <Grid item xs={12} sm={4}>
                                    <Box sx={{ textAlign: 'center' }}>
                                        <Typography variant="h4" color="info.main">
                                            {tasks.filter(t => getTaskTimeStatus(t).status === 'upcoming').length}
                                        </Typography>
                                        <Typography variant="body2" color="text.secondary">
                                            Sắp tới
                                        </Typography>
                                ...
                                <Grid item xs={12} sm={4}>
                                    <Box sx={{ textAlign: 'center' }}>
                                        <Typography variant="h4" color="success.main">
                                            {tasks.filter(t => t.trang_thai === 'hoan_thanh').length}
                                        </Typography>
                                        <Typography variant="body2" color="text.secondary">
                                            Đã hoàn thành
                                        </Typography>
