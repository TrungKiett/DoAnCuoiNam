// Note: Project is under http://yensonfarm.io.vn, so API lives at /khoi_api/api
const API_BASE = process.env.REACT_APP_API_BASE || "http://yensonfarm.io.vn/khoi_api/api";
