            ...
            <div className="max-w-7xl mx-auto px-6 py-12 grid md:grid-cols-4 gap-10">
                ...
                <div>
                    ...
                    <p className="text-sm leading-6 mb-6">
                        ...
                        for efficient, eco-friendly farming practices
                    </p>
                ...
                <div>
                    ...
                    <ul className="space-y-5 text-sm">
                        <li className="flex gap-3">
                            <img src="https://via.placeholder.com/60" alt="news1" className="w-16 h-16 object-cover rounded" />
                            <div>
                        ...
                        <li className="flex gap-3">
                            <img src="https://via.placeholder.com/60" alt="news2" className="w-16 h-16 object-cover rounded" />
                            <div>
                                <p className="text-xs text-gray-400">July 14, 2025</p>
                                <a href="#" className="hover:text-yellow-400">
