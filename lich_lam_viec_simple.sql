-- Tạo bảng lich_lam_viec đơn giản (không có foreign key)
-- Chạy SQL này trước để tạo bảng cơ bản
...
CREATE INDEX idx_lich_lam_viec_trang_thai ON lich_lam_viec(trang_thai);
