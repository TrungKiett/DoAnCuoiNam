...
try {
    ...
    $stmt = $pdo->prepare("INSERT INTO ke_hoach_san_xuat (ma_lo_trong, dien_tich_trong, ngay_du_kien_thu_hoach, trang_thai, ma_nong_dan, ghi_chu) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->execute([$ma_lo_trong, $dien_tich_trong, $ngay_du_kien_thu_hoach, $trang_thai, $ma_nong_dan, $ghi_chu]);
